...
###  Part 1 Plot the 30-day mortality rates for heart attack ([outcome.R](https://github.com/pavankonam/datasciencecoursera/blob/master/outcome.R))
...
outcome[, lapply(.SD
        ...
        , .SDcols = (11)]
```
![](https://github.com/pavankonam/datasciencecoursera/blob/master/Hospital_30_day_death.png)
###  Part 2 Finding the best hospital in a state ([best.R](https://github.com/pavankonam/datasciencecoursera/blob/master/best.R))
```R
...
```
###  Part 3 Ranking hospitals by outcome in a state ([rankhospital.R](https://github.com/pavankonam/datasciencecoursera/blob/master/rankhospital.R))
```R
...
```
###  Part 4 Ranking hospitals in all states ([rankall.R](https://github.com/pavankonam/datasciencecoursera/blob/master/rankall.R))
```R
